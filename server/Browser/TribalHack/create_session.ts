...
export default function createSession(browser: Browser, server: { url: string, map: string },credentials: Credentials, output: (...args: any[]) => void): Promise<void> {
